...
export interface BlackjackRules {
  ...
  dealerHitsSoft17: true     // H17 everywhere
 ...
 *  - SPLIT can be disallowed for Aces once split; engine enforces.
 */

// Dealer upcard keys normalize to: 2..11 (where 11 = Ace)
...
/** MULTI-DECK, H17, DAS — baseline table (tiny tweaks from your original) */
const MULTI_H17_DAS = {
  pairs: {
  ...
  soft: {
    ...
    // A,8: stand vs 2 per common H17 baseline (you had double vs 2)
    19: {2:'STAND',3:'STAND',4:'STAND',5:'DOUBLE',6:'DOUBLE',7:'STAND',8:'STAND',9:'STAND',10:'STAND',11:'STAND'} as Record<Up,BjAction>,
    18: {2:'STAND',3:'DOUBLE',4:'DOUBLE',5:'DOUBLE',6:'DOUBLE',7:'STAND',8:'STAND',9:'HIT',10:'HIT',11:'HIT'} as Record<Up,BjAction>, // A,7
    ...
    13: {2:'HIT',3:'HIT',4:'HIT',5:'DOUBLE',6:'DOUBLE',7:'HIT',8:'HIT',9:'HIT',10:'HIT',11:'HIT'} as Record<Up,BjAction>,
...
/** SINGLE-DECK H17 DAS — same baseline for now */
...
export function basicStrategyAction(
  ...
  // If split aces: engine forces 1-card then stand; trainer echoes STAND.
